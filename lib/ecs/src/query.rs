...
// API's heavier imports moved into `runner`.
use crate::entity::Entity;
// Only the in-root `mod tests` still names `Component` (its `#[derive]`
// fixtures, reached via `super::*`); production root code does not.
#[cfg(test)]
use crate::Component;
...
// Only the `mod tests` below still names `DenseMut` directly (via
// `super::*`); the production code that used it moved into the submodules.
#[cfg(test)]
